...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.likeCount setFont:[UIFont fontWithName:@"Arial" size:12]];
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_mediaImageView]|" options:kNilOptions metrics:nil views:viewDictionary]];
         [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_usernameAndCaptionLabel][_likeCount(==38)][_likeButton(==38)]|" options:NSLayoutFormatAlignAllTop | NSLayoutFormatAlignAllBottom metrics:nil views:viewDictionary]];
        ...
        self.likeCountHeightConstraint = [NSLayoutConstraint constraintWithItem:_likeCount
                                                                 ...
                                                                 multiplier:1
                                                                   constant:38];
        self.likeCountHeightConstraint.identifier = @"Like Count height constraint";
        ...
        [self.contentView addConstraints:@[self.imageHeightConstraint, self.usernameAndCaptionLabelHeightConstraint, self.commentLabelHeightConstraint, self.likeCountHeightConstraint]];
    }
    return self;
}
