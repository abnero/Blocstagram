...
@property (nonatomic, strong) UITapGestureRecognizer *twoFingersTap;
...
+ (NSString *) instagramClientID {
    return @"1cac1392bdcb48b0afe32711a0f004c3";
}
...
//Create a new method requestNewItem to retrieve images automatically

//refreshing page using pulling down gesture
